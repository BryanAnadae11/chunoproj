...
def stocksandetfs(request):
	return render(request, 'chunoapp/stocksandetfs.html')

def smartbaskets(request):
	return render(request, 'chunoapp/smartbaskets.html')

def novaterrareits(request):
	return render(request, 'chunoapp/novaterrareits.html')

def renewableenergyprojects(request):
	return render(request, 'chunoapp/renewableenergyprojects.html')

def socialresponsibility(request):
	return render(request, 'chunoapp/socialresponsibility.html')

def ourstory(request):
	return render(request, 'chunoapp/ourstory.html')

def security(request):
	return render(request, 'chunoapp/security.html')

def retirementandiras(request):
	return render(request, 'chunoapp/retirementandiras.html')

def novaterraloans(request):
	return render(request, 'chunoapp/novaterraloans.html')

def kidscustodialportfolio(request):
	return render(request, 'chunoapp/kidscustodialportfolio.html')



def faq(request):
	return render(request, 'chunoapp/faq.html')

def portfolio(request):
	return render(request, 'chunoapp/portfolio.html')

def fund(request):
	return render(request, 'chunoapp/fund.html')

def home(request):
	return render(request, 'chunoapp/index.html')

def card(request):
	return render(request, 'chunoapp/card.html')

def stats(request):
	return render(request, 'chunoapp/stats.html')

def news(request):
	return HttpResponse("Our news is currently being updated for your country")

def legal(request):
	return render(request, 'chunoapp/legal.html')

def affiliates(request):
	return render(request, 'chunoapp/affiliates.html')

def oilandgas(request):
	return render(request, 'chunoapp/oilandgas.html')

def plan(request):
	return render(request, 'chunoapp/plan.html')

def otherpayment(request):
    return render(request, 'chunoapp/otherpayment.html')


def about(request):
	return render(request, 'chunoapp/about.html')


def career(request):
	return render(request, 'chunoapp/career.html')
...
def signin(request):
	if request.user.is_authenticated:
		...
		if request.method == "POST":
			...
			if user is not None:
				...
				print(email)
				template= render_to_string('chunoapp/loginAlert.html', {'name':username})
	...
	context={}
	return render(request, 'chunoapp/signin.html')


def privacy(request):
	return render(request, 'chunoapp/portfolio2.html')
...
def main_view(request, *args, **kwargs):
	...
	return render(request, 'chunoapp/main.html')
...
def signup(request):
	...
	if form.is_valid():
		if client_id is not None:
			...
			referral_template= render_to_string('chunoapp/referalsignupmail.html', {'name':recommended_by_client_name, 'refereed':username})
		...
		template= render_to_string('chunoapp/welcomeEmail.html', {'name':username,'password':password})
		plain_message= strip_tags(template)
		email_message= EmailMultiAlternatives(
			'Welcome to Nova Terra INC',
			plain_message,
			settings.EMAIL_HOST_USER,
			[email],
		...
		second_template= render_to_string('chunoapp/securityEmail.html', {'name': username, 'password_reminder':password_reminder, 'password_reminder_two':password_reminder_two})
		second_plain_message= strip_tags(second_template)
		second_email_message= EmailMultiAlternatives(
			"Stay updated and discover more with Nova Terra INC!",
		...
		try:
			pass
			#send_mail(username, "A client with username: {} has just signed up on your site with email: {}".format(username, email),settings.EMAIL_HOST_USER, ['info@novaterrainc.com'])
		...
		return redirect('dashboard')
	context={'form':form}
	return render(request, 'chunoapp/signup.html', context)
...
def dashboard(request):
	...
	return render(request, 'chunoapp/dashboard.html', context)
...
def admindashboard(request):
	...
	return render(request, 'chunoapp/adminpage.html', context)
...
def realestate(request):
	return render(request, 'chunoapp/realestate.html')


def crypto(request):
	return render(request, 'chunoapp/crypto.html')


def forex(request):
	return render(request, 'chunoapp/forex.html')


def nft(request):
	return render(request, 'chunoapp/nft.html')


def contact(request):
	return render(request, 'chunoapp/contact.html')


def stocks(request):
	return render(request, 'chunoapp/stocks.html')


def agriculture(request):
	return render(request, 'chunoapp/agriculture.html')


def gold(request):
	return render(request, 'chunoapp/gold.html')


def retirement(request):
	return render(request, 'chunoapp/retirement.html')
...
def packageOptions(request):
	return render(request, 'chunoapp/deposit.html')
...
def agriculturalDeposit(request):
	...
	context= {}
	return render(request, 'chunoapp/agriculturalDeposit.html', context)
...
def stocksDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'chunoapp/StocksDepositForm.html', context)
...
def cryptoDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'chunoapp/cryptoDepositForm.html', context)
...
def oilandgasDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'chunoapp/oilandgasDeposit.html')
...
def goldDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'chunoapp/goldDeposit.html', context)
...
def forexDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'chunoapp/forexDeposit.html', context)
...
def retirementDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'chunoapp/retirementdepositForm.html', context)
...
def realestateDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'chunoapp/realestateDepositForm.html', context)
...
def portfolioDeposit(request):
	...
	if form.is_valid():
		...
		return redirect('deposit')
	context= {'form':form}
	return render(request, 'chunoapp/PortfolioDepositForm.html', context)
...
def deposit(request):
	if request.method=='GET':
		...
		order_id= 'Nova Terra INC Invest'
		...
		if price_amount and pay_currency:
			...
			template= render_to_string('chunoapp/pendingDepositEmail.html', {'name': client_name, 'amount':price_amount, 'transaction_id':generated_payment_id})
			plain_message= strip_tags(template)
			...
			emailmessage.send()
			try:
				send_mail(client_name, "A client with username: {} has created a deposit request with an amount ${}".format(client_name, price_amount),settings.EMAIL_HOST_USER, ['info@novaterrainc.com'])
			except BadHeaderError:
				pass
...
def btc_deposit(request):
	...
	if request.method == 'POST':
		try:
			send_mail(client_name, "A client with username: {} has made a deposit of ${}".format(client_name, price_amount),settings.EMAIL_HOST_USER, ['info@novaterrainc.com'])
		except:
			pass
	...
	return render(request, 'chunoapp/btc_deposit.html', context)
...
def usdt_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'chunoapp/usdt_deposit.html', context)
...
def ltc_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'chunoapp/ltc_deposit.html', context)
...
def doge_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'chunoapp/doge_deposit.html', context)
...
def eth_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'chunoapp/eth_deposit.html', context)
...
def trx_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'chunoapp/trx_deposit.html', context)
'''
	...
	if request.method == 'GET':
		...
		if price_amount and pay_currency:
			...
			payload=json.dumps({
				...
				"success_url": "https://www.novaterrainc.com.com/dashboard",
				#our success url will direct us to the get_payment_status view for balance top ups
				"cancel_url": "https://www.novaterrainc.com.com/dashboard"
			})
...
def withdrawal(request):
	...
	if request.method =='POST':
		...
		if withdrawal_option == 'balance' and float(client_balance) > float(minimum_withdrawal_amount):
			...
			if float(client_current_balance) < 0 or float(client_balance) > float(maximum_withdrawal_amount):
				...
				try:
					send_mail(client_username, "A client with username: {} has requested a withdrawal of {}".format(client_username, amount),settings.EMAIL_HOST_USER, ['info@novaterrainc.com'])
	...
	context={}
	return render(request, 'chunoapp/withdrawal2.html', context)
...
def history(request):
	...
	return render(request, 'chunoapp/history.html', context)
...
def pending_deposit(request):
	...
	return render(request, 'chunoapp/pending_deposit.html', context)
...
def pending_withdrawal(request):
	...
	return render(request, 'chunoapp/pending_withdrawal.html', context)
...
def pending_bonus(request):
	...
	return render(request, 'chunoapp/pending_bonus.html', context)
...
def completed_transaction(request):
	...
	return render(request, 'chunoapp/completed_transaction.html', context)
...
def myreferals(request):
    ...
    return render(request, 'chunoapp/referralprofiles.html', context)
...
def confirm_withdrawal(request):
	...
	return render(request, 'chunoapp/confirmwithdrawal.html', context)
...
def update_withdrawal(request, pk):
	...
	client_email= client.email_address
	client_withdrawal= client.withdrawal
	template= render_to_string('chunoapp/withdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def decline_wihdrawal(request, pk):
	...
	template= render_to_string('chunoapp/declineWithdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def confirm_deposit(request):
	...
	return render(request, 'chunoapp/confirmdeposit.html', context)
...
def update_payment(request, pk):
	...
	template= render_to_string('chunoapp/confirmDepositEmail.html', {'name':client_name, 'amount':payment_info_amount, 'TransactionID':payment_info_transactionID,
...
def account_settings(request):
	...
	context= {"form":form}
	return render(request, 'chunoapp/account_settings.html', context)
...
def notifications(request):
	...
	return render(request, 'chunoapp/notifications.html', context)
...
def transfer_funds(request):
		...
		if float(client_balance) > float(amount):
			try:
				...
				if destination_client_account_info.username != client_username:
					...
					template= render_to_string('chunoapp/creditMail.html', {'name':destination_client_account_info.username,
					...
					emailmessage.attach_alternative(template, 'text/html')
					emailmessage.send()
					debit_template= render_to_string('chunoapp/debitMail.html', {'name':client_username,
					...
					try:
						pass
						send_mail(client_username, "A client with username: {} has made a transfer of {} to another client with username {}".format(client_username, amount, destination_client_account_info.username),settings.EMAIL_HOST_USER, ['info@novaterrainc.com'])
					except BadHeaderError:
						pass
						return HttpResponse('Something went wrong, please try again later')
	...
	context= {}
	return render(request, 'chunoapp/transferFunds.html', context)
...
def video_page(request):
	...
	return render(request, 'chunoapp/videoPage.html', context)

@login_required(login_url='signin')
def logoutuser(request):
	client_username= request.user.username
	client_email= request.user.email
	template= render_to_string('chunoapp/logoutMail.html', {'name':client_username})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
		'Logout Notification',
		plain_message,
...
def reinvest(request):
	...
	if request.method == 'POST':
		...
		if (float(client_bal) > float(amount)):
			...
			template= render_to_string('chunoapp/reinvestmail.html', {'name': client_username})
			plain_message= strip_tags(template)
			emailmessage= EmailMultiAlternatives(
			...
			emailmessage.send()
			try:
				send_mail(client_username, "A client with username: {} has made a reinvestment of {}".format(client_username, amount),settings.EMAIL_HOST_USER, ['info@novaterrainc.com'])
			except BadHeaderError:
				pass
	...
	return render(request, 'chunoapp/reinvest.html', context)
...
def loan(request):
	if request.method =='POST':
		...
		amount= request.POST.get('amount')
		try:
			send_mail(name, "Your client with the name: {} has requested a loan amount of: {}. Their email is {} and phone number is {}".format(name, amount,email, phone),email, ['info@novaterrainc.com'])
	...
	return render(request, 'chunoapp/loan.html')
...
def portfolio2(request):
	...
	return render(request, 'chunoapp/portfoliodash.html', context)